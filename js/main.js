...
var clientsCarousel = function() {
  var carouselList = $('#carousel ul');
    function changeSlide() {
        carouselList.animate({'marginLeft': -144}, 1000, moveFirstSlide);
    }
...
/*
    ...
    $('#next').on('click', function () {
        carouselList.animate({'marginLeft': -200}, 1000, moveFirstSlide);
    });
    ...
    $('#prev').on('click', function () {
        ...
        carouselList.css({marginLeft: -200}).animate({'marginLeft': 0}, 1000);//zrób animacje od -400 do 0, trwającą 1000ms
    });
